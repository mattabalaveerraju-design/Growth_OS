    ...
    <AppShell title="Interview Prep">
      <div className="space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h1 className="font-display text-[28px] font-semibold tracking-[-0.025em]">Interview Prep</h1>
            <p className="text-[13.5px] text-ink-soft">Interview questions, notes, and preparation resources</p>
          </div>
          <button
            type="button"
            onClick={openNew}
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Are you sure you want to delete this interview prep topic?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
