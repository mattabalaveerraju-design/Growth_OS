    ...
    <div className="min-h-screen w-full bg-surface text-ink">
      ...
      <div className="flex min-h-screen w-full">
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <Link
                        key={item.to}
                        to={item.to}
                        className={`group flex items-center gap-2.5 rounded-[10px] px-3 py-2 text-[13.5px] font-medium transition-all ${
                          active
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-16 border-b border-border bg-surface/80 backdrop-blur-xl sticky top-0 z-10 px-6 lg:px-10 flex items-center gap-4">
