  ...
  const handleSave = () => {
    if (activeTab === "Task") {
      addTask({
        ...
        priority: values.task.priority as TaskItem["priority"],
        status: values.task.status as TaskItem["status"],
        dueDate: values.task.dueDate,
        notes:
          [values.task.description.trim(), values.task.notes.trim()].filter(Boolean).join("\n\n") ||
          "",
      });
    ...
    if (activeTab === "Goal") {
      addGoal({
        ...
        type: values.goal.type as GoalItem["type"],
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(event) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, title: event.target.value },
                          }))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(event) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, description: event.target.value },
                          }))
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(event) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, category: event.target.value },
                          }))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(event) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, dueDate: event.target.value },
                          }))
                        }
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, priority: value as TaskItem["priority"] },
                          }))
                        }
                      >
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setValues((current) => ({
                            ...current,
                            task: { ...current.task, status: value as TaskItem["status"] },
                          }))
                        }
                      >
                        <SelectTrigger className="mt-2">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(event) =>
                        setValues((current) => ({
                          ...current,
                          task: { ...current.task, notes: event.target.value },
                        }))
                      }
                    />
                  </div>
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        learning: { ...current.learning, topic: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        learning: { ...current.learning, category: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        learning: { ...current.learning, source: event.target.value },
                      }))
                    }
                  />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Input
                      ...
                      onChange={(event) =>
                        setValues((current) => ({
                          ...current,
                          learning: { ...current.learning, date: event.target.value },
                        }))
                      }
                    />
                    <div />
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        learning: { ...current.learning, notes: event.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, company: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, position: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, country: event.target.value },
                      }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                    <Input
                      ...
                      onChange={(event) =>
                        setValues((current) => ({
                          ...current,
                          application: { ...current.application, appliedDate: event.target.value },
                        }))
                      }
                    />
                    <Input
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, salary: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, interviewStage: event.target.value },
                      }))
                    }
                  />
                  <select
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        application: { ...current.application, notes: event.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        goal: { ...current.goal, title: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        goal: { ...current.goal, category: event.target.value },
                      }))
                    }
                  />
                  <select
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        goal: { ...current.goal, type: event.target.value as GoalItem["type"] },
                      }))
                    }
                    className="rounded-[10px] border border-border bg-background px-3 py-2 text-sm text-ink outline-none focus:ring-2 focus:ring-primary/30"
                  >
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        goal: { ...current.goal, status: event.target.value },
                      }))
                    }
                  />
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        goal: { ...current.goal, notes: event.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        focus: { ...current.focus, title: event.target.value },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        focus: { ...current.focus, category: event.target.value },
                      }))
                    }
                  />
                  <div className="grid grid-cols-2 gap-3">
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...
                        focus: {
                          ...current.focus,
                          priority: event.target.value as FocusItem["priority"],
                        },
                      }))
                    }
                  />
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...
                        focus: {
                          ...current.focus,
                          status: event.target.value as FocusItem["status"],
                        },
                      }))
                    }
                  />
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        interview: { ...current.interview, title: event.target.value },
                      }))
                    }
                  />
                  <select
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        interview: { ...current.interview, content: event.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div className="grid gap-3">
                  <Input
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        vault: { ...current.vault, title: event.target.value },
                      }))
                    }
                  />
                  <select
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        vault: { ...current.vault, type: event.target.value as "note" | "file" },
                      }))
                    }
                    className="rounded-[10px] border border-border bg-background px-3 py-2 text-sm text-ink outline-none focus:ring-2 focus:ring-primary/30"
                  >
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        vault: { ...current.vault, content: event.target.value },
                      }))
                    }
                  />
                </div>
                ...
                <div className="grid gap-3">
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        project: { ...current.project, description: event.target.value },
                      }))
                    }
                  />
                  <select
                    ...
                    onChange={(event) =>
                      setValues((current) => ({
                        ...current,
                        project: { ...current.project, status: event.target.value },
                      }))
                    }
                    className="rounded-[10px] border border-border bg-background px-3 py-2 text-sm text-ink outline-none focus:ring-2 focus:ring-primary/30"
                  >
